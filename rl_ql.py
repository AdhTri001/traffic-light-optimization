...
def get_state():  #3.& 4. Constraint 3 & 4
    ...
    q_EB_0 = get_queue_length(detector_Node2_3_WB_0)
    q_EB_1 = get_queue_length(detector_Node2_3_WB_1)
    q_EB_2 = get_queue_length(detector_Node2_3_WB_2)
